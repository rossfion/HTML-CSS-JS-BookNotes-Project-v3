...
As with the first version, none of the links work. In addition, the mobile navigation does not work although the relevant styling has been applied. I have left this up to your imagination as to how you wish to approach functionality. The basic functionality has already been implemented in the <a href="https://github.com/rossfion/HTML-CSS-JS-BookNotes-Project-v1" target="_blank">first version</a>.
...
<a href="https://github.com/rossfion/HTML-CSS-JS-BookNotes-Project-v4" target="_blank">Link to the fourth and final version</a> of its kind. At least, for now...
